...
const;
isRhino = typeof Packages == "object" && Object.prototype.toString.call(Packages) == "[object JavaPackage]"; // Move to the next token
...
pp.readEscapedChar = function(inTemplate) {
    ...
    default:
        if (ch >= 48 && ch <= 55) {
            let;
            octalStr = this.input.substr(this.pos - 1, 3).match(/^[0-7]+/)[0];
            let;
