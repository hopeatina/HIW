...
export class DomCompiler extends RenderCompiler {
    constructor(_stepFactory, _viewLoader, _sharedStylesHost) {
        super();
...
export let DefaultDomCompiler = class extends DomCompiler {
    constructor(parser, viewLoader, sharedStylesHost, appId) {
        super(new DefaultStepFactory(parser, appId), viewLoader, sharedStylesHost);
    }
};
DefaultDomCompiler = __decorate([
    Injectable(),
    __param(3, Inject(APP_ID_TOKEN)), 
    __metadata('design:paramtypes', [Parser, ViewLoader, SharedStylesHost, Object])
], DefaultDomCompiler);
