...
export declare class DomProtoView {
    ...
    static create(type: ViewType, rootElement: Element, viewEncapsulation: ViewEncapsulation, fragmentsRootNodeCount: number[], rootTextNodeIndices: number[], elementBinders: List<DomElementBinder>, hostAttributes: Map<string, string>): DomProtoView;
    constructor(type: ViewType, rootElement: Element, encapsulation: ViewEncapsulation, elementBinders: List<DomElementBinder>, hostAttributes: Map<string, string>, rootTextNodeIndices: number[], boundTextNodeCount: number, fragmentsRootNodeCount: number[], isSingleElementFragment: boolean);
}
