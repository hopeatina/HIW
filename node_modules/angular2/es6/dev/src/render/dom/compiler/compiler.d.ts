...
export declare class DomCompiler extends RenderCompiler {
    ...
    constructor(_stepFactory: CompileStepFactory, _viewLoader: ViewLoader, _sharedStylesHost: SharedStylesHost);
...
export declare class DefaultDomCompiler extends DomCompiler {
    constructor(parser: Parser, viewLoader: ViewLoader, sharedStylesHost: SharedStylesHost, appId: any);
}
