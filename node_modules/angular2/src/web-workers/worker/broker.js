...
var MessageBroker = (function () {
    function MessageBroker(_messageBus, _serializer) {
        var _this = this;
    ...
    MessageBroker.prototype.runOnUiThread = function (args, returnType) {
        ...
        if (returnType != null) {
            ...
            promise = async_1.PromiseWrapper.then(completer.promise, function (data) {
                if (_this._serializer == null) {
                    return data.value;
                }
                else {
                    return _this._serializer.deserialize(data.value, returnType);
                }
            });
        }
        else {
    ...
    MessageBroker = __decorate([
        di_1.Injectable(), 
        __metadata('design:paramtypes', [Object, serializer_1.Serializer])
    ], MessageBroker);
