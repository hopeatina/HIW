...
var selectorTokens = [
    "ident", "string", "selector", "function", "comment", "boolean", "space", "color", "unit", "for", "in", "[", "]", "(", ")", "+", "-", "*", "*=", "<", ">", "=", ":", "&", "~", "{", "}", ".", "/"
];
...
Parser.prototype = {
   ...
   */
    ...
    looksLikeSelector: function(fromProperty) {
        ...
        // Trailing separators
        while (!~[
            "indent", "outdent", "newline", "for", "if", ";", "}", "eos"
   ...
   */
    ...
    assignment: function() {
        ...
        if (op =
            ...
            switch (op.type) {
            case "?=":
                var defined = new nodes.BinOp("is defined", node), lookup = new nodes.Ident(name);
