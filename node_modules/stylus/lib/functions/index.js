...
exports.hsla = function hsla(hue, saturation, lightness, alpha) {
    ...
    case 2:
        ...
        return new nodes.HSLA(
            color.h, color.s, color.l, alpha.val);
    default:
        ...
        return new nodes.HSLA(
            hue.val, saturation.val, lightness.val, alpha.val);
    }
};
...
exports.hsl = function hsl(hue, saturation, lightness) {
    if (1 == arguments.length) {
        ...
        return exports.hsla(
            hue, saturation, lightness, new nodes.Unit(1));
    }
};
...
exports.rgba = function rgba(red, green, blue, alpha) {
    ...
    case 2:
        ...
        return new nodes.RGBA(
            color.r, color.g, color.b, alpha.val);
    default:
...
exports.rgb = function rgb(red, green, blue) {
    ...
    default:
        return exports.rgba(
            red, green, blue, new nodes.Unit(1));
    }
};
...
exports.selector = function selector(sel) {
    var stack = this.selectorStack, group;
