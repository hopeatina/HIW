...
// normalizes slashes.
    ...
    function Minimatch(pattern, options) {
        ...
        if (!options) options = {};
        pattern = pattern.trim(); // windows: need to use /, not \
...
// a{b}c -> a{b}c
    ...
    function braceExpand(pattern, options) {
        ...
        var suf = braceExpand.call(this, pattern.substr(i), options); // ["b", "c{d,e}","{f,g}h"] ->
        //   [["b"], ["cd", "ce"], ["fh", "gh"]]
        ...
        this.debug("set expanded", set); // [["b"], ["cd", "ce"], ["fh", "gh"]] ->
        //   ["b", "cd", "ce", "fh", "gh"]
        ...
        for (var fi = 0,
            ...
            if (p === GLOBSTAR) {
                ...
                WHILE: while (fr < fl) {
                    ...
                    this.debug("\nglobstar while",
                        file, fr, pattern, pr, swallowee); // XXX remove this slice.  Just pass the start index.
