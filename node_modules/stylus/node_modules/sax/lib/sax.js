...
// Set to Infinity to have unlimited buffers.
    ...
    var whitespace = "\r\n\t "
        ...
        rootNS = { xml: XML_NAMESPACE, xmlns: XMLNS_NAMESPACE }; // turn all the string character sets into character class objects.
...
// is left as an exercise for the reader.
    ...
    function newTag(parser) {
        ...
        var parent = parser.tags[parser.tags.length - 1] || parser, tag = parser.tag = { name: parser.tagName, attributes: {} }; // will be overridden if tag contails an xmlns="foo" or xmlns:foo="bar"
